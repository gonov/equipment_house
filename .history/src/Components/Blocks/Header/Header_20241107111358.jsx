        ...
        <WidthBlock>
          <div className={classes.headerContainer1}>
            ...
            <ul className={classes.navone}>
              ...
              <li><Link to="/solution"> Готовые решения для бизнеса </Link></li>
          ...
          <div className={classes.headerContainer2}>
            ...
            <div className={classes.search}>
              ...
              <button><img src="/images/Background.png" alt="" /></button>
            </div>
        ...
        <CenterBlock>
          <WidthBlock>
            <ul className={classes.navTwo}>
              <li><a href="">Тепловое</a></li>
              <li><a href="">Холодильное</a></li>
              <li><a href="">Электромеханическое</a></li>
              <li><a href="">Посудомоечное</a></li>
              <li><a href="">Нейтральное</a></li>
              <li><a href="">Линии раздачи</a></li>
