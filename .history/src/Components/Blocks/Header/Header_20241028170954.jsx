    ...
    <>
      <CenterBlock>
        <WidthBlock>
          ...
          <div className={classes.headerContainer2}>    /* средняя часть конец */
            ...
            <div className={classes.buttons}>
                <button><img src='/images/cart1.png' alt=''></img></button>
                <button><img src='images/Frame2.png' alt=''></img></button>
                <button><img src='' alt=''></img> ВЫйти</button>
                <button><img src='' alt=''></img> Регистр</button>
            </div>
          </div>
        </WidthBlock>
      </CenterBlock>
