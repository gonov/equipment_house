        ...
        <CenterBlock>
          <WidthBlock>
            <ul className={classes.navTwo}>
              ...
              <li>
                <Link to="/category/1">Холодильное</Link>
              </li>
              <li>
                <Link to="/category/1">Электромеханическое</Link>
              </li>
              <li>
                <Link to="/category/1">Посудомоечное</Link>
              </li>
              <li>
                <Link to="/category/1">Нейтральное</Link>
              </li>
              <li>
                <Link to="/category/1">Линии раздачи</Link>
              </li>
              <li>
                <Link to="/category/1">Аксессуары</Link>
              </li>
            </ul>
          </WidthBlock>
        </CenterBlock>
