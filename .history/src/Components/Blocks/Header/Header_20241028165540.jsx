        ...
        <WidthBlock>
          ...
          <div className={classes.headerContainer2}>
            ...
            <div className={classes.buttons}>
                <div className={classes.but1}><button><img src='/images/cart.png' alt=''></img> корзина</button></div>
                <div className={classes.but2}><button><img src='images/frame 2.png' alt=''></img> Войти</button></div>
                <div className={classes.but3}><button><img src='' alt=''></img> ВЫйти</button></div>
                <div className={classes.but3}><button><img src='' alt=''></img> Регистр</button></div>
            </div>
          </div>
        </WidthBlock>
      </CenterBlock>
