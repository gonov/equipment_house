        ...
        <CenterBlock>
          <WidthBlock>
            <ul className={classes.navTwo}>
              <li>
                <Linkt="">Тепловое</Linkt=>
              </li>
              <li>
                <Linkt="">Холодильное</Linkt=>
              </li>
              <li>
                <Linkt="">Электромеханическое</Linkt=>
              </li>
              <li>
                <Linkt="">Посудомоечное</Linkt=>
              </li>
              <li>
                <Linkt="">Нейтральное</Linkt=>
              </li>
              <li>
                <Linkt="">Линии раздачи</Linkt=>
              </li>
              <li>
                <Linkt="">Аксессуары</Linkt=>
              </li>
            </ul>
          </WidthBlock>
        </CenterBlock>
