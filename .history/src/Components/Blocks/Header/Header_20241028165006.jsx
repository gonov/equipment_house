        ...
        <WidthBlock>
          ...
          <div className={classes.headerContainer2}>
            ...
            <div className={classes.buttons}>
                <div className={classes.but1}><button>корзина</button></div>
                <div className={classes.but2}><button>корзина</button></div>
                <div className={classes.but3}><button>корзина</button></div>
                <div className={classes.but}><button>корзина</button></div>
            </div>
          </div>
        </WidthBlock>
      </CenterBlock>
