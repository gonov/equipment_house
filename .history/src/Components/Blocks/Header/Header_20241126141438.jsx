...
function Header() {
  ...
  useEffect(() => {
    try {
      // Пытаемся получить токен из cookies или localStorage
      ...
      setUserData(null); // Сбрасываем данные, если токен некорректный
    }
  }, []);
        ...
        <WidthBlock>
          <div className={classes.headerContainer1}>
            ...
            <ul className={classes.navone}>
              ...
              <li><Link to="/solutions">Готовые решения для бизнеса</Link></li>
        ...
        <CenterBlock>
          <WidthBlock>
            <ul className={classes.navTwo}>
              <li><Link to="/category/1">Тепловое</Link></li>
              <li><Link to="/category/2">Холодильное</Link></li>
              <li><Link to="/category/3">Электромеханическое</Link></li>
              <li><Link to="/category/4">Посудомоечное</Link></li>
              <li><Link to="/category/5">Нейтральное</Link></li>
              <li><Link to="/category/6">Линии раздачи</Link></li>
              <li><Link to="/category/7">Аксессуары</Link></li>
            </ul>
          </WidthBlock>
        </CenterBlock>
      </div>
