        ...
        <WidthBlock>
          ...
          <div className={classes.headerContainer2}>
            ...
            <div className={classes.buttons}>
                <div className={classes.but1}><button><img src='/images/cart1.png' alt=''></img> корзина</button></div>
                <div className={classes.but2}><button><img src='images/Frame2.png' alt=''></img> </button></div>
