...
export const OrdersEdit = (props) => (
  <Edit {...props}>
    <SimpleForm>
      ...
      <TextInput source="paymentMethod" label="Способ оплаты" validate={required()} />
      ...
      <ArrayInput source="orderItems" validate={required()}>
        <SimpleFormIterator>
          <ReferenceInput source="productId" reference="products" label="Продукт" validate={required()}>
