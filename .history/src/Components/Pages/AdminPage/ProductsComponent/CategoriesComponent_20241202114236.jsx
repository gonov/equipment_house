...
import { uploadFiles, uploadFiles } from '../JS/fileUploadUtils';
...
export const handleSave = async (values) => {
  if (values.img) {
    ...
    const uploadedImage = await uploadFiles(values.img);
...
export const CategoriesCreate = (props) => (
  <Create {...props} transform={handleSave}>
    <SimpleForm>
      ...
      <ImageInput source="img" label="Загрузить изображение" accept="image/*">
