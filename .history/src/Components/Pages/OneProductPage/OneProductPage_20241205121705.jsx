...
function OneProductPage() {
    ...
    const fetchData = async () => {
      try {
        ...
        if (fetchedProduct.img && fetchedProduct.img.length > 0) {
          setMainImg(fetchedProduct.img.length === 1 ? fetchedProduct.img[0] : fetchedProduct.img[1]);
        }
  ...
  // Функция для отображения характеристик как списка
      ...
      <WidthBlock>
        ...
        <div className={classes.container1}>
          ...
          <div className={classes.container1Characteristics}>
            <p>Характеристики</p>
            {/* Если выбрано отображение характеристик */}
            {mainDescription === product.characteristics ? (
              <ul>
              ...
              <p>{product.description}</p> // Если отображаем описание, то показываем описание
            )}
          </div>
