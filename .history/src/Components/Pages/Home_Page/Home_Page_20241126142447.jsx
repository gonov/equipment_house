  ...
  const [formData, setFormData] = useState({
    ...
    useEffect(() => {
      const fetchData = async () => {
        ...
        try {
          // Загрузка товаров
          const productsResponse = await fetch('https://your-api-endpoint.com/products');
          const productsData = await productsResponse.json();
          setProducts(productsData);
  
          // Загрузка бизнес-решений
          ...
          // Загрузка новостей
          const newsResponse = await fetch('https://your-api-endpoint.com/news');
