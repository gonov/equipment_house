        ...
        <WidthBlock>
          ...
          <div className="classes.feedbackBlock">
            <div className={classes.inputBlock1}>
              <input type="text" placeholder="ФИО" className={classes.inpName} />
              <input type="email" placeholder="E-mail" className={classes.inpEmail} />
            </div>
            <div className={classes.inputBlock2}>
            <input type="number" placeholder="Телефон" className={classes.inpPhone} />
            <input type="text" placeholder="Комментарий" className={classes.inpComment} />
            </div>
            <div className={classes.send}>
              <Checkbox></Checkbox>
              <span>Отправляя форму, я даю согласие на обработку персональных <br></br></span>
            </div>
          </div>
        </WidthBlock>
      </CenterBlock>
