    ...
    <CenterBlock>
      <WidthBlock>
        <div className={classes.container1}>
          ...
          <button style={{ zIndex: '9999' }} onClick={() => swiper4.slidePrev()}>
            <img src="/images/left.png" alt="Previous" />
          </button>
          <button style={{ zIndex: '9999' }} onClick={() => swiper4.slideNext()}>
        ...
        <div className={classes.container3}>
          <div className={classes.column}>
            ...
            <button>
              <img src="/images/Group6.png" alt="Group 6" />
            </button>
            <button>
              <img src="/images/Group11.png" alt="Group 11" />
            </button>
          </div>
          <div className={classes.column}>
            <button>
              <img src="/images/Group2.png" alt="Group 2" />
            </button>
            <button>
              <img src="/images/Group7.png" alt="Group 7" />
            </button>
            <button>
              <img src="/images/Group12.png" alt="Group 12" />
            </button>
          </div>
          <div className={classes.column}>
            <button>
              <img src="/images/Group3.png" alt="Group 3" />
            </button>
            <button>
              <img src="/images/Group8.png" alt="Group 8" />
            </button>
            <button>
              <img src="/images/Group13.png" alt="Group 13" />
            </button>
          </div>
          <div className={classes.column}>
            <button>
              <img src="/images/Group4.png" alt="Group 4" />
            </button>
            <button>
              <img src="/images/Group9.png" alt="Group 9" />
            </button>
            <button>
              <img src="/images/Group14.png" alt="Group 14" />
            </button>
          </div>
          <div className={classes.column}>
            <button>
              <img src="/images/Group5.png" alt="Group 5" />
            </button>
            <button>
              <img src="/images/Group10.png" alt="Group 10" />
            </button>
            <button>
              <img src="/images/Group15.png" alt="Group 15" />
            </button>
          </div>
        </div>
        ...
        <div className={classes.container4}>
          ...
          <div className={classes.solForBus}>
            <div className={classes.textForSolution}>
              <span>Готовые решения для бизнеса<br /></span>
              <span>Используя готовые решения, вы можете оптимизировать свой бизнес - <br /></span>
              <span>процессы, повысить качество обслуживания гостей и увеличить прибыль.</span>
            </div>
