...
function CategoryPage({ children, ...props }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        // Загружаем категории (если они не меняются, можно убрать)
    ...
    fetchData();
  }, [categoryId]); // Добавили зависимость от categoryId
        ...
        <div className={classes.container}>
          ...
          <div className={classes.rightBlock}>
            <div className={classes.rightBlockFilter}>
              <button
                className={sortOrder === 'asc' ? classes.activeFilter : ''}
                onClick={() => handleSortChange('asc')}
              >
                По возрастанию цены
              </button>
              <button
                className={sortOrder === 'desc' ? classes.activeFilter : ''}
