  ...
  const getUserFromToken = () => {
    ...
    if (token) {
      try {
        ...
        console.log(decodedToken); // Выводим декодированные данные (например, имя и email)
        return decodedToken;
      } catch (error) {
...
if (user) {
  console.log("Имя пользователя:", user.name);  // Получаем имя из декодированного токена
  console.log("Email пользователя:", user.email);  // Получаем email
}
